...
class Xsd2PhpElementTest  extends Xsd2PhpBase
{
    ...
    public function testElementOfPrimitiveType($xsType, $phpName)
    {
        ...
        $this->assertInstanceOf('Goetas\Xsd\XsdToPhp\Structure\PHPClass', $classes['Example\ElementOne']);
        ...
        $this->assertCount(0, $classes['Example\ElementOne']->getTraits());
    ...
    public function testElementOfBaseType($xsType, $phpName)
    {
        ...
        $this->assertInstanceOf('Goetas\Xsd\XsdToPhp\Structure\PHPClass', $extension);
